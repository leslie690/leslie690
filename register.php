...
if($result){
    ...
    if($num > 0){
        ...
        if($password === $cpassword){
            $sql = "INSERT INTO register(id, fname, mname, lname, username, pnumber, gender, password, cpassword) VALUES('$id', '$fname', '$mname', '$lname', '$username', '$pnumber', '$gender', '$password', '$cpassword')";
